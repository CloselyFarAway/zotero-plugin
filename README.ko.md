...
> 현재 버전: **v0.1.4**. 핵심 stored PDF → linked file 변환 흐름은 v0.1.3 + Windows Zotero 10.0.4에서 실제 동작을 확인했고, v0.1.4는 그 위에 안전성과 사용성을 개선한 버전입니다. 처음 대량 이동하기 전에는 Zotero 데이터와 중요한 PDF를 백업하는 것을 권장합니다.
